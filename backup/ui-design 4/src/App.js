...
{/*         
   ...
   <Avatar alt='src' src={ava} />
    ...
    <div>
     ...
     {/* <div class="row">
      <div class="col-sm-6">
                 ...
                 <button  class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                   <span data-bind="label"> &nbsp;<span class="flag-icon flag-icon-au"></span>EN</span>
                 </button>
                 <ul class="dropdown-menu" role="menu">
                    <li><a href="#"><span class="flag-icon flag-icon-au"></span>EN</a></li>
                    <li><a href="#"><span class="flag-icon flag-icon-fr"></span>FR</a></li>
      ...
      <div>
       ...
       <Container>
       <h1>Online Marketing Dashboard</h1>
         <div>
     ...
     {value ===0?'VISITS':value ===1?'TOTAL PAGE VIEWS':value ===2?'NEW USERS':'BOUNCE RATE'}
                </div>
              <Bar 
